	...
	<div id="register" class="container">
		...
		<ul class="lg_list">
			...
			<li class="clearfix lg_top">
				<i class="lg_icon3"></i>
				<div class="lg_cot2">
					<input type="password" v-model="password" placeholder="请输入密码" class="lg_code" id="lg_code2" />
				</div>
			</li>
			<li class="clearfix lg_top">
				<i class="lg_icon4"></i>
				...
				if (reg.test(this.phone)) {
					...
					password:this.password, check_password:this.repeatPassword, vcode:this.vcode })).then(response => {
						...
						if (response.status == 1) {
							window.localStorage.setItem('api_token', response.user.api_token);
...
<style>
	...
	.lg_icon1 {
		width: 2rem;
		height: 2rem;
		background-image: url(http://bankall.iwocar.com/images/lg_icon1.png);
	...
	.lg_cot1 {
		...
		height: 2rem;
		float: left;
		background-image: url(http://bankall.iwocar.com/images/lg_bg.png);
		background-repeat: no-repeat;
		background-size: contain;
		position: relative;
	}
	...
	.lg_icon2 {
		width: 2rem;
		height: 2rem;
		background-image: url(http://bankall.iwocar.com/images/lg_icon2.png);
		background-repeat: no-repeat;
		background-size: contain;
		float: left;
		margin-left: 0.4rem;
	...
	.lg_icon3 {
		width: 2rem;
		height: 2rem;
		background-image: url(http://bankall.iwocar.com/images/suo2.png);
		background-repeat: no-repeat;
		background-size: contain;
		float: left;
		margin-left: 0.4rem;
	...
	.lg_icon4 {
		width: 2rem;
		height: 2rem;
		background-image: url(http://bankall.iwocar.com/images/suo1.png);
		background-repeat: no-repeat;
		background-size: contain;
		float: left;
		margin-left: 0.4rem;
